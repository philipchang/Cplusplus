...
#ifndef __TBT_BASELIB_MCGBCODE_H__
#define __TBT_BASELIB_MCGBCODE_H__

#include "../ComDef/common.h"

namespace TBT_BaseLib
{
...
class mcCode {};
typedef mcGBCodeT<mcCode> mcGBCode;
